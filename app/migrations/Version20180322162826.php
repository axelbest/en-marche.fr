...
class Version20180322162826 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE abstract_organizational_chart_item (id INT UNSIGNED AUTO_INCREMENT NOT NULL, parent_id INT UNSIGNED DEFAULT NULL, label VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, INDEX IDX_4300BEE5727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE referent_person_link ADD CONSTRAINT FK_BC75A60A810B5A42 FOREIGN KEY (person_organizational_chart_item_id) REFERENCES abstract_organizational_chart_item (id)');
